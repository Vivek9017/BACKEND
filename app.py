...
# ===========================
st.set_page_config(page_title="Preventive Health AI", layout="wide")
...
st.markdown("Fill in your health details below to predict risk levels.")
...
if st.button("Predict Risk"):
    ...
    try:
        ...
        for i, risk in enumerate(risk_names):
            ...
            st.success(f"{risk}: {label} (Confidence: {round(confidence,3)})")
